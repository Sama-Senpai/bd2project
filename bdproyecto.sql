...
CREATE TABLE `habitacion` (
  ...
  `nPuerta` char(5) NOT NULL COMMENT 'Numero en la pueerta, fisico',
  PRIMARY KEY (`n_hab`,`cod_hotel`,`cod_CH`),
...
insert  into `habitacion`(`n_hab`,`cod_hotel`,`cod_CH`,`nPuerta`) values (2,2,90,''),(3,2,90,''),(4,2,90,''),(5,1,110,''),(6,1,90,''),(12,1,110,'12121'),(13,1,110,'00222'),(14,5,232,'11111'),(15,3,110,'22122'),(16,1,90,'10202');
...
insert  into `habitacion_hotel`(`Hotel_cod`,`catalogo_habitacion_cod_ch`,`precio_dia`,`cantidad`,`NroAdicionales`,`descripcion`,`poseeHab`) values (1,90,2300,5,5,'no',1),(1,110,5000,7,10,'hol',1),(2,90,1400,30,2,'no',1),(3,110,12212,22,100,'habitacion Mateim',1),(5,232,12000,12,1,'vista al mar',1);
...
insert  into `hotel`(`cod_hotel`,`rif`,`nombre`,`n_tlf`,`direccion`,`dir_elec`,`numero_camas_dips`,`numero_camas_totales`) values (1,'rif-E343GE','Cascada','02869612133','Frente a la churruata','Cascadaelhotel@gmail.com',100,100),(2,'rif-123432DDD','El Balde','02556322','Ucab','Ucabelhotel@gmail.com',30,30),(3,'Merucho','RIF-223223','CAse','02867782223','meruchohotel@gmail.com',120,120),(4,'RIF-22322sds','Meruchin','028677832','CAsesss','mel@gmail.com',124,124),(5,'RIF-223223','Hotel los Conquistadores','0223312342','Av nuevo mexico, espa̱a','losConqui@gmail.com',100,100),(6,'RIF-223223','Hotel los Conquistadores','0223312342','Av nuevo mexico, espa̱a','losConqui@gmail.com',100,100),(7,'rif','Ho','232','wdwd','sds',111,111),(8,'gfewf','dgfds','323','vew','vewv',3232,3232);
...
CREATE TABLE `reserva_hospedaje` (
  ...
  `r&c` int(11) NOT NULL COMMENT 'preservacion y reservacion \n0- si esta en reserva\n1- si el pago esta confirmado\n2- la cancelo y no vendra',
  `camas_adicionales` int(11) NOT NULL DEFAULT '0',
  `p+ad` int(11) NOT NULL DEFAULT '0' COMMENT 'el monto pagado mas las camas adicionales',
...
insert  into `reserva_hospedaje`(`id_reserva`,`Cliente_CI`,`cod_hotel`,`cod_CH`,`numero_paquete`,`numero_hab`,`f_inicio`,`f_fin`,`f_reserva`,`pagado`,`r&c`,`camas_adicionales`,`p+ad`) values (3,2233166,1,90,3,6,'2015-05-15','2015-05-16','2015-05-15',1,1,1,200),(2,2233166,2,90,2,4,'2015-05-30','2015-06-02','2015-05-15',0,0,0,0),(1,25620021,1,110,1,5,'2016-06-15','2015-05-23','2015-05-15',1,1,2,400);
