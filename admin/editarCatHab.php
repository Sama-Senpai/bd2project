...
<?php require_once('../modulos/scriptjs.php'); ?> 
    ...
    <div class="jumbotron">
      <div class="container">
        <h1>Editar Catalgo de Habitacion</h1>
        <p>Para modificar una habitacion en el catalogo debe llenar el formulario</p>
      </div>
    </div>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
            ...
            <form role="form" method="POST" action="../BD/admin/editarCatHabitaciones.php">
